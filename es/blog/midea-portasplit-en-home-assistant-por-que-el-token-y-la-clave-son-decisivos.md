...
description: "El control local requiere dos valores de la nube de Midea. Así se obtienen el token y la clave, por qué su pérdida es problemática y cómo los propietarios pueden proteger su configuración actual."
date: "2026-07-24"
...
translatedAt: 2026-09-04T08:28:56.634Z
...
<aside class="article-update">
  <p class="article-update__label">Qué deberían hacer ahora los propietarios de una PortaSplit</p>
  <p>A través de interfaces privadas de la nube, Home Assistant obtiene durante la configuración el token y la clave específicos del dispositivo. El proyecto Midea AC LAN advierte desde el 19 de mayo de 2025 de posibles cambios. Sin embargo, no hay documentada una fecha concreta de desactivación por parte del fabricante. Para los propietarios, esto significa:</p>
  <ol>
    <li><strong>No deshacer innecesariamente una configuración existente.</strong> Solo la obtención de las credenciales requiere la nube de Midea. Futuros cambios en el endpoint privado podrían dificultar una nueva configuración.</li>
...
El proyecto Midea AC LAN advierte de posibles cambios en estas interfaces de la nube. Sin embargo, análisis más recientes muestran que de ello no puede derivarse una hoja de ruta confirmada del fabricante ni una fecha concreta de desactivación. Este artículo explica la relación técnica de dependencia; el [análisis detallado de la API](/blog/midea-v2-cloud-api-portasplit-home-assistant) contextualiza las distintas denominaciones «V2» y la situación actual.
