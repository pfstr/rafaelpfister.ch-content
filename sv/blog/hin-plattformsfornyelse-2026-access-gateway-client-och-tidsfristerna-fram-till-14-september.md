---
title: "HIN-plattformsförnyelse 2026: Access Gateway, Client och tidsfristerna till 14 september"
navTitle: "Access Gateway 2026"
description: "Brandväggsöppning senast 14 augusti, Access Gateway version 4 från 17 augusti, SAML-slutpunkter, hårdvarutoken och HIN Client senast 14 september. Mailgateway påverkas inte och ersätts separat."
date: "2026-08-01"
...
translatedAt: 2026-09-02T08:12:37.122Z
...
<div class="choice-row">
  ...
  <a class="choice" href="/stargate">
    ...
    <span class="choice__hint">Då väntar även ersättningen med «Stargate», med bred utrullning från Q3 2026. Kostnadsfri kontroll av din miljö. →</span>
  </a>
</div>
...
Den som driver en federation driver nästan alltid också en egen e-postinfrastruktur. För dessa organisationer sammanfaller plattformsförnyelsen med [ersättningen av Mailgateway med «Stargate»](/stargate) under samma år: tekniskt oberoende, men konkurrerande om samma personer och underhållsfönster.
...
2. Tillåter brandväggen utgående `idp.id.hin.ch`?
...
<aside class="offer-box">
  ...
  <p><strong>Du behöver inte veta var du står. Det är precis vad kontrollen är till för.</strong> Jag ser över din befintliga gatewaymiljö och berättar vad som behöver göras före migrationsfönstret, oavsett om du sedan migrerar själv eller tar hjälp.</p>
...
2.  [Den nya HIN Client är här: detta förändras för HIN-medlemmar](https://www.hin.ch/de/blog/2026/neuer-hin-client.cfm): version 4.0, operativsystemkrav, webbläsarbaserad inloggning.
...
5.  [Anslutning till Active Directory](https://cdn.hin.ch/agw/manual/DE/5-anbindung-active-directory.html): Kerberos och LDAP-kontot med läsrättigheter.
