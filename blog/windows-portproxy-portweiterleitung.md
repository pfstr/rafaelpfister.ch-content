---
title: "Portweiterleitung mit netsh portproxy: interne Dienste über einen Jumphost erreichen"
...
| `listenaddress` | Lokale Adresse, auf der gehört wird; hier die VPN-Adresse des Jumphosts, damit nur über das VPN eingegangen wird |
...
- **Keine zusätzliche Verschlüsselung.** Die Weiterleitung kopiert Bytes unverändert. Die Vertraulichkeit der Strecke liefert allein das VPN, über das Sie den Jumphost erreichen. Über ein unverschlüsseltes Transportnetz wäre der Verkehr ungeschützt.
