...
protokolle:
  ...
  - "migration"
  - "releases"
slug: "exchange-online-drosselt-und-blockiert-alte-exchange-server"
translationId: "article-fff0c5efce59ef76"
url: "https://rafaelpfister.ch/blog/exchange-online-drosselt-und-blockiert-alte-exchange-server"
draft: false
---
...
Frank Zöchling hat die Ankündigung auf [Frankys Web](https://www.frankysweb.de/exchange-online-drosselt-und-blockiert-alte-exchange-server-versionen/) zusammengefasst. Dieser Beitrag ergänzt die Hintergründe: Wie das Enforcement seit 2023 aufgebaut ist, welche SMTP-Antworten Ihr Server zu sehen bekommt, wie Sie den Stand im Admin Center und per PowerShell prüfen und welche Optionen im Übergang bis zum Ende des ESU-Programms im Oktober 2026 bleiben.
...
4.  [Exchange Online drosselt und blockiert alte Exchange Server Versionen – Frankys Web](https://www.frankysweb.de/exchange-online-drosselt-und-blockiert-alte-exchange-server-versionen/): Deutschsprachige Zusammenfassung der September-Ankündigung mit den KB-Nummern der Mindestversionen.
...
7.  [Description of the security update for Microsoft Exchange Server 2016 CU23: October 14, 2025 (KB5066369) – Microsoft Support](https://support.microsoft.com/en-us/topic/description-of-the-security-update-for-microsoft-exchange-server-2016-cu23-october-14-2025-kb5066369-8ca2ab99-dfde-4329-896a-3faa677d2603): Der KB-Artikel zum Mindeststand für Exchange 2016 CU23.

8.  [Support for Exchange Server 2016 and Exchange Server 2019 ends today – Microsoft Community Hub](https://techcommunity.microsoft.com/blog/exchange/support-for-exchange-server-2016-and-exchange-server-2019-ends-today/4461192): Das Supportende am 14. Oktober 2025.

9.  [Announcing Exchange 2016 / 2019 Extended Security Update program – Microsoft Community Hub](https://techcommunity.microsoft.com/blog/exchange/announcing-exchange-2016--2019-extended-security-update-program/4433495): Bedingungen der ersten ESU-Periode.
...
11. [Exchange Online transport enforcement system explained – CodeTwo Admin's Blog](https://www.codetwo.com/admins-blog/persistently-vulnerable-exchange-server/): Tabellarische Aufschlüsselung der acht Enforcement-Stufen und der Rollout-Daten je Exchange-Version; Drittquelle.

12. [Exchange Server Health Checker – Microsoft CSS-Exchange](https://aka.ms/ExchangeHealthChecker): Inventarisierung von CU/SU-Ständen und offenen manuellen Schritten.
