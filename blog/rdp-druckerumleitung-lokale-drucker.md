...
Der schnellste Weg führt über die grafische Oberfläche: `mstsc` starten, **Optionen einblenden**, Reiter **Lokale Ressourcen**, Haken bei **Drucker** setzen und die Verbindung im Reiter **Allgemein** speichern. Wer stattdessen mit .rdp-Dateien arbeitet, setzt die entsprechende Zeile direkt in der Datei; .rdp-Dateien sind einfache Textdateien und lassen sich mit jedem Editor bearbeiten:
