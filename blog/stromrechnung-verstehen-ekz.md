...
slug: "stromrechnung-verstehen-ekz"
url: "https://rafaelpfister.ch/blog/stromrechnung-verstehen-ekz"
...
<div class="sr-meta">Ihre Rechnung vom 01.03.2026 bis 31.05.2026<br>Musterhaushalt, Einfamilienhaus, Netztarif EKZ Netz 400F, 1'800 kWh</div>
</div>
<div class="sr-block">
<div class="sr-blocktitle">Energielieferung</div>
<div class="sr-row" tabindex="0" data-sr="energie-winter"><span class="sr-label">Energietarif Jan.–März</span><span class="sr-calc">600 kWh × 13.30 Rp.</span><span class="sr-amount">79.80</span></div>
<div class="sr-row" tabindex="0" data-sr="energie-sommer"><span class="sr-label">Energietarif Apr.–Juni</span><span class="sr-calc">1'200 kWh × 9.00 Rp.</span><span class="sr-amount">108.00</span></div>
<div class="sr-row" tabindex="0" data-sr="grundtarif"><span class="sr-label">Grundtarif</span><span class="sr-calc">3 Monate × CHF 3.00</span><span class="sr-amount">9.00</span></div>
</div>
<div class="sr-block">
<div class="sr-blocktitle">Netznutzung</div>
<div class="sr-row" tabindex="0" data-sr="netz"><span class="sr-label">Netz 400F</span><span class="sr-calc">1'800 kWh × 7.50 Rp.</span><span class="sr-amount">135.00</span></div>
<div class="sr-row" tabindex="0" data-sr="sdl"><span class="sr-label">Systemdienstleistungen (SDL)</span><span class="sr-calc">1'800 kWh × 0.27 Rp.</span><span class="sr-amount">4.86</span></div>
</div>
<div class="sr-block">
<div class="sr-blocktitle">Messung</div>
<div class="sr-row" tabindex="0" data-sr="messung"><span class="sr-label">Messtarif</span><span class="sr-calc">3 Monate × CHF 5.00</span><span class="sr-amount">15.00</span></div>
</div>
<div class="sr-block">
<div class="sr-blocktitle">Zuschläge und Abgaben</div>
<div class="sr-row" tabindex="0" data-sr="bundesabgaben"><span class="sr-label">Bundesabgaben</span><span class="sr-calc">1'800 kWh × 2.30 Rp.</span><span class="sr-amount">41.40</span></div>
<div class="sr-row" tabindex="0" data-sr="stromreserve"><span class="sr-label">Stromreserve</span><span class="sr-calc">1'800 kWh × 0.41 Rp.</span><span class="sr-amount">7.38</span></div>
<div class="sr-row" tabindex="0" data-sr="solidarisiert"><span class="sr-label">Solidarisierte Kosten</span><span class="sr-calc">1'800 kWh × 0.05 Rp.</span><span class="sr-amount">0.90</span></div>
<div class="sr-row" tabindex="0" data-sr="effizienz"><span class="sr-label">Förderung Energieeffizienz</span><span class="sr-calc">1'800 kWh × 0.16 Rp.</span><span class="sr-amount">2.88</span></div>
</div>
<div class="sr-block sr-sums">
<div class="sr-row sr-net" tabindex="0" data-sr="netto"><span class="sr-label">Nettobetrag (exkl. MWST)</span><span class="sr-calc"></span><span class="sr-amount">404.22</span></div>
<div class="sr-row" tabindex="0" data-sr="mwst"><span class="sr-label">8.1 % Mehrwertsteuer</span><span class="sr-calc"></span><span class="sr-amount">32.74</span></div>
<div class="sr-row sr-total" tabindex="0" data-sr="total"><span class="sr-label">Rechnungsbetrag</span><span class="sr-calc"></span><span class="sr-amount">CHF 436.95</span></div>
</div>
</div>
...
<div data-exp="energie-winter"><strong>Energie, Winterquartal</strong><p>Der eigentliche Strom. Seit 2026 verrechnet die EKZ statt Hoch- und Niedertarif einen Einheitstarif pro Quartal: 13.30 Rp./kWh im Winterhalbjahr (Januar bis März, Oktober bis Dezember). Absender: Energielieferant. Das ist der einzige Block, in dem ein anderes Produkt gewählt werden kann.</p></div>
<div data-exp="energie-sommer"><strong>Energie, Sommerquartal</strong><p>Dieselbe Energie, anderer Preis: 9.00 Rp./kWh von April bis September. Der Sommer ist günstiger, weil Wasserkraft und Solarstrom dann reichlich vorhanden sind. Die Saisonpreise machen sichtbar, was am Strommarkt schon lange gilt: Strom hat je nach Jahreszeit einen anderen Wert.</p></div>
<div data-exp="grundtarif"><strong>Grundtarif Energie</strong><p>Fixer Monatsbetrag der Energielieferung (CHF 3.00 pro Monat), unabhängig vom Verbrauch. Deckt Abrechnung und Vertrieb.</p></div>
<div data-exp="netz"><strong>Netznutzung, Arbeitspreis</strong><p>Der Transport: Bau, Betrieb und Unterhalt des Stromnetzes. Ein reguliertes Monopol, wechseln kann man den Netzbetreiber nicht. Der Preis hängt vom gewählten Netzprodukt ab: Standardtarif 400ST 7.95 Rp./kWh, 400F mit netzdienlicher Steuerung 7.50 Rp./kWh, Wärmepumpentarif 400WP 6.45 Rp./kWh (alle exkl. MWST). Genau an dieser Position setzt der LEG-Abschlag von 20 oder 40 Prozent an.</p></div>
<div data-exp="sdl"><strong>Systemdienstleistungen</strong><p>Der Beitrag an Swissgrid für die Stabilität des Übertragungsnetzes: Frequenzhaltung, Regelleistung, Blindenergie. 0.27 Rp./kWh, bei allen Netzbetreibern ähnlich.</p></div>
<div data-exp="messung"><strong>Messung</strong><p>Betrieb des Zählers und Bereitstellung der Messdaten, seit 2026 als eigene Position ausgewiesen (vorher in der Netznutzung enthalten). CHF 5.00 pro Monat. Der Smart Meter, der hier bezahlt wird, ist übrigens die technische Voraussetzung für eine LEG-Teilnahme.</p></div>
<div data-exp="bundesabgaben"><strong>Bundesabgaben (Netzzuschlag)</strong><p>Der gesetzliche Netzzuschlag nach Art. 35 Energiegesetz: 2.30 Rp./kWh für die Förderung erneuerbarer Energien und die ökologische Sanierung der Wasserkraft. Vom Bund festgelegt, bei jedem Endverbraucher gleich.</p></div>
<div data-exp="stromreserve"><strong>Stromreserve</strong><p>Swissgrid-Tarif zur Finanzierung der Winterreserve: Wasserkraftreserve, Reservekraftwerke, Notstromgruppen. Eine Folge der Energiekrise 2022. 0.41 Rp./kWh.</p></div>
...
<style>
.sr-embed { margin: 28px 0; }
.sr-grid { display: grid; grid-template-columns: minmax(0, 3fr) minmax(0, 2fr); gap: 16px; align-items: start; }
.sr-paper { background: var(--card, #fffaf3); border: 1px solid var(--hairline, #dfdad9); border-radius: 12px; padding: 20px 22px; font-size: 14.5px; }
.sr-head { border-bottom: 1px solid var(--hairline, #dfdad9); padding-bottom: 12px; margin-bottom: 12px; }
.sr-brand { font-weight: 700; letter-spacing: 0.02em; }
.sr-meta { color: var(--muted, #52525b); font-size: 13px; margin-top: 4px; line-height: 1.45; }
.sr-blocktitle { font-weight: 600; font-size: 13px; text-transform: uppercase; letter-spacing: 0.05em; color: var(--muted, #52525b); margin: 14px 0 4px; }
.sr-row { display: flex; gap: 10px; align-items: baseline; padding: 6px 8px; margin: 0 -8px; border-radius: 8px; cursor: pointer; outline-offset: 2px; }
.sr-row:hover, .sr-row:focus-visible, .sr-row.sr-active { background: var(--surface, #f2e9e1); }
.sr-row.sr-active .sr-label { color: var(--accent, #286983); }
.sr-label { flex: 1 1 auto; min-width: 0; }
.sr-calc { color: var(--faint, #a1a1aa); font-size: 12.5px; white-space: nowrap; }
.sr-amount { font-variant-numeric: tabular-nums; font-weight: 600; min-width: 64px; text-align: right; }
.sr-sums { border-top: 1px solid var(--hairline, #dfdad9); margin-top: 14px; padding-top: 6px; }
.sr-total .sr-label, .sr-total .sr-amount { font-weight: 700; font-size: 15.5px; }
.sr-panel { position: sticky; top: 96px; }
.sr-panel-inner { background: var(--surface, #f2e9e1); border: 1px solid var(--hairline, #dfdad9); border-radius: 12px; padding: 16px 18px; font-size: 14.5px; line-height: 1.55; min-height: 120px; }
.sr-panel-inner p { margin: 6px 0 0; }
.sr-panel-hint { color: var(--muted, #52525b); font-style: italic; }
@media (max-width: 760px) {
  .sr-grid { grid-template-columns: 1fr; }
  .sr-panel { position: static; }
  .sr-calc { display: none; }
}
</style>

<script>
(function () {
  var embed = document.querySelector(".sr-embed");
  if (!embed) return;
  var panel = embed.querySelector("#sr-panel-target");
  var expl = embed.querySelector("#sr-explanations");
  var active = null;
  function show(row) {
    if (!row || !panel || !expl) return;
    var key = row.getAttribute("data-sr");
    var content = expl.querySelector('[data-exp="' + key + '"]');
    if (!content) return;
    if (active) active.classList.remove("sr-active");
    active = row;
    row.classList.add("sr-active");
    panel.innerHTML = content.innerHTML;
  }
  embed.addEventListener("mouseover", function (e) {
  ...
  embed.addEventListener("focusin", function (e) {
    var row = e.target.closest(".sr-row");
    if (row) show(row);
  });
})();
...
| Netzprodukt | Arbeitspreis (exkl. MWST) | Bedingung |
| --- | --- | --- |
| EKZ Netz 400ST (Standard) | 7.95 Rp./kWh | keine |
| EKZ Netz 400F | 7.50 Rp./kWh | EKZ darf flexible Lasten (Boiler, Wärmepumpe) netzdienlich steuern |
| EKZ Netz 400WP | 6.45 Rp./kWh | Wärmeanwendungen mit Steuerung |

Wer die Steuerung seines Boilers zulässt, spart also knapp einen halben Rappen pro Kilowattstunde gegenüber dem Standard. Und seit 2026 gibt es einen zweiten Hebel an dieser Position: Wer einer lokalen Elektrizitätsgemeinschaft (LEG) beitritt, erhält auf dem Arbeitspreis der Netznutzung einen gesetzlichen Abschlag von 20 oder 40 Prozent für den lokal gehandelten Strom. Was eine LEG ist, steht im [eigenen Beitrag](/blog/lokale-elektrizitaetsgemeinschaft-leg-erklaert); ob sich das rechnet, [im nächsten](/blog/lohnt-sich-leg-beitritt).
...
Genau deshalb lohnt der Blick auf die Positionen: Der grösste einzelne Hebel eines Haushalts liegt beim Verbrauch selbst, danach kommen Netzprodukt-Wahl, Energieprodukt und neu die LEG. Für Letztere haben wir einen [Preisrechner](/tools/leg-rechner) gebaut, der die Rechnung dieses Artikels fortführt.
