...
description: "Brannmurgodkjenning innen 14. august, Access Gateway versjon 4 fra 17. august, SAML-endepunkter, maskinvaretokener og HIN Client innen 14. september. Mailgatewayet er ikke berørt og erstattes separat."
date: "2026-08-01"
...
translatedAt: 2026-09-02T08:13:16.425Z
...
<div class="choice-row">
  <a class="choice" href="#die-fristen">
    ...
    <span class="choice__title">Kun AGW i drift</span>
    <span class="choice__hint">Fristene nedenfor er hele ditt handlingsbehov. →</span>
  </a>
  <a class="choice" href="/stargate">
    <span class="choice__label">Din situasjon</span>
    <span class="choice__title">I tillegg migreringsbehov for Mailgateway</span>
    <span class="choice__hint">Da står også erstatningen med «Stargate» for tur, med bred utrulling fra tredje kvartal 2026. Gratis gjennomgang av ditt miljø. →</span>
  </a>
</div>
...
2. Tillater brannmuren utgående trafikk til `idp.id.hin.ch`?
3. Hvor mange arbeidsstasjoner kjører fortsatt Windows 10 eller macOS 13 og eldre?
4. Hvor mange maskinvaretokener er i bruk, og hva skal de berørte bytte til?
...
<aside class="offer-box">
  ...
  <p><strong>Du trenger ikke å vite hvor du står. Det er nettopp derfor gjennomgangen finnes.</strong> Jeg ser på ditt eksisterende Gateway-miljø og forteller deg hva som må gjøres før migreringsvinduet, uavhengig av om du deretter migrerer selv eller får bistand.</p>
  <a class="offer-box__cta" href="/stargate">Registrer deg nå</a>
</aside>

## Kilder

1.  [HIN-plattformfornyelse: Disse tekniske tilpasningene kreves for HIN-medlemmer](https://www.hin.ch/de/blog/2026/technische-anpassungen.cfm): Frister i august og september, SAML-endepunkter, redusert attributtmengde, brannmurgodkjenninger.
...
3.  [HIN Gateway: Sikker kommunikasjon innenfor HIN Community](https://www.hin.ch/de/services/hin-mail/hin-gateway.cfm): Erstatning av Mailgateway, arkitektur, driftsmodeller, migrering i bestilte tidsvinduer.

4.  [Konfigurasjon av HIN Access Gateway](https://cdn.hin.ch/agw/manual/DE/4-konfiguration-des-hin-access-gateway.html): AGWs rolle i tilgangsstyringen.

5.  [Tilkobling til Active Directory](https://cdn.hin.ch/agw/manual/DE/5-anbindung-active-directory.html): Kerberos og LDAP-kontoen med leserettigheter.

6.  [HIN AG: «Fra Mailgateway til Data Mesh»](https://www.hin.ch/de/blog/2025/vom-mailgateway-zum-data-mesh.cfm): Bakgrunn om «Stargate», desentraliserte noder, tidsplan.
